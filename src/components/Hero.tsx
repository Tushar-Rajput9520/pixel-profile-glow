      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-300 my-6 backdrop-blur-sm bg-black/30 p-4 rounded-lg shadow-lg shadow-neonGreen/10">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80 animate-float">
              ...
              <div className="absolute inset-2 overflow-hidden rounded-full border-2 border-neonGreen/50 bg-gradient-to-br from-midnight to-secondary glow-border holographic">
                <img
