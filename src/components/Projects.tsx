  ...
  const projects: Project[] = [
    {
      id: 1,
      title: 'Investax',
      description: 'A Zerodha-inspired trading platform with real-time market data and user-friendly dashboard.',
    ...
    },
    {
      ...
      description: 'A comprehensive task management application with Kanban boards, team collaboration and analytics.',
    ...
    },
    {
      id: 3,
      title: 'FoodFinder',
      description: 'A restaurant discovery app with geolocation, ratings, and personalized recommendations.',
    ...
    },
    {
      id: 4,
      title: 'CodeCollab',
      description: 'A collaborative code editor with real-time syncing, video chat, and an integrated terminal.',
      techStack: ['Next.js', 'TypeScript', 'WebRTC', 'Docker'],
